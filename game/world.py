...
class World (context.Context):
    ...
    def __init__ (self, s):
        ...
        island_list = [island.Island, monster_island_mbadj002.MonsterIsland]
        ...
        testland = monster_island_mbadj002.MonsterIsland (self.startx, self.starty+1, self)
        ...
        self.events.append(large_wave_mbadj002.Large_wave())
